...
/* Define to 1 if you have the `espeak-ng' library (-lespeak-ng). */
#define HAVE_LIBESPEAK_NG 1

/* Define to 1 if you have the `estools' library (-lestools). */
/* #undef HAVE_LIBESTOOLS */
